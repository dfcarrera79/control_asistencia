...
const opcionesHorarios = ref(props.schedules);
const opcion = ref<RespuestaHorario>({
  codigo: 0,
  nombre: '',
  horario: [],
});
        ...
        <div class="q-pl-md q-py-sm row items-center">
          ...
          <div class="q-pl-md">
            <q-btn
              ...
              icon="access_time"
              @click="handleButtonClicked(opcion.codigo, selected)"
              :disable="opcion.codigo == 0 || selected.length == 0"
            />
          </div>
        </div>
      </div>
